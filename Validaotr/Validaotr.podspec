...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Validaotr"
  spec.version      = "1.0.0"
  spec.summary      = "A short description of Validaotr."
  spec.description  = "this is test description"

  spec.homepage     = "https://github.com/Haroon700/Validaotr"
  ...
  spec.source       = { :git => "https://github.com/Haroon700/Validaotr.git", :tag => spec.version.to_s }
  ...
  spec.source_files  = "Validaotr/**/*.{swift}"
